...
\begin{itemize}
    \item in recent years NN for image classififcation has evolved a lot
    \item it's researches obligation to ensure NN robustness and reliability
    \item It’s widely known fact that NN are vulnerable against adversarial attacks. ~\cite{ilyas2019adversarial}
    \item pretect tasks had shown themsef usefull to improve accuracvy, andf also are belived to contribute to models learnig of important features
    \item so, In this research I would like to evaluate how including state-of-the-art pretext in training process influence
