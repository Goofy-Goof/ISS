...
Number of training epochs was varied in [15, 30, 45] for pretext training, Number of epochs for downstream training was set to 30.
\\
...
Number of miss-classifications was recorded.
\\
...
the result were compared with EffNet trained for 30 epochs without pretext task and EffNet pre-trained for image classification on ImageNet.
\\
